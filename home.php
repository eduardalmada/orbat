                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="./php/login.php" method="POST">
                            <label for="usrname">Usuário</label>
                             <input type="text" class="form-control" id="usrname" placeholder="Digite o usuário" name="usuario">
                             <br>
                             <label for="pwd">Senha:</label>
                              <input type="password" class="form-control" placeholder="Digite a senha" id="pwd" name="senha">
